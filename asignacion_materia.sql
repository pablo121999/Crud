...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-01-2023 a las 06:24:46
...
CREATE TABLE `registro_materias` (
  ...
  `id_estudiante` char(40) NOT NULL,
  `id_docente` char(40) NOT NULL,
  `id_asignatura` char(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `registro_materias` (`id_registro`, `id_estudiante`, `id_docente`, `id_asignatura`) VALUES
(1, '1', '1', '1'),
(5, '1', '2', '4');
...
--
ALTER TABLE `docente`
  MODIFY `id_docente` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `estudiante`
--
ALTER TABLE `estudiante`
  MODIFY `id_estudiante` mediumint(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `registro_materias`
--
ALTER TABLE `registro_materias`
  MODIFY `id_registro` mediumint(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
